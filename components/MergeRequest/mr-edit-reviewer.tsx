...
function Reviewer({ reviewer, children }: { reviewer: any, children: React.ReactNode }) {
    ...
    return (
        <>
            ...
            <SectionTitle title="Reviewers">
                ...
                <EditParamMergeRequestDialog title="Reviewers" handleSave={handleSave} loading={updating} error={updateError}>
