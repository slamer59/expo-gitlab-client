...
const events = [
    ...
    { user: 'anna-geller', action: 'added', eventType: 'comment', label: 'technical-mr', labelType: 'technical-mr' },
    { user: 'tchiotludo', action: 'added', eventType: 'review', label: 'kind/cooldown', labelType: 'other' },
    { user: 'tchiotludo', action: 'removed', eventType: 'pull-request', label: 'kind/technical-mr', labelType: 'other' },
    { user: 'anna-geller', action: 'added', eventType: 'discussion', label: 'enhancement', labelType: 'enhancement' },
    { user: 'anna-geller', action: 'added', eventType: 'assignee', label: 'kind/good-first-mr', labelType: 'other' },
    { user: 'anna-geller', action: 'added', eventType: 'review-request', label: 'kind/good-first-mr', labelType: 'other' },
    { user: 'anna-geller', action: 'added', eventType: 'mention', label: 'kind/good-first-mr', labelType: 'other' }
];
...
export function MergeRequestEventComponent({ notes }: { notes: any }) {
