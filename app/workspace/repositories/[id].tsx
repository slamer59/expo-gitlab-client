...
const Repositories = () => {
    ...
    if (isError) {
        setError({
            ...
            diggest: `Error fetching data for projectId: ${projectId}`,
        });
    }
            ...
            {isLoading ? <Loading /> : <>
                <View className="p-4 m-2">
                    <View className="flex-row items-center">
                        <Ionicons
                            ...
                            color="black"
                        />
                        <Text className="ml-2 text-lg font-bold text-light dark:text-primaryDark">
                            {repository.owner || "Default name"}
                        </Text>
                    </View>
                ...
                <View className="p-4 m-2 bg-gray-200 rounded-lg">
                    ...
                    {buttons.map((button, index) => (
                        ...
                        >
                            ...
                            <Text className="ml-2 text-base text-right">
                                {button.kpi}
                            </Text>
                        </TouchableOpacity>
                    ))}
                ...
                <View className="p-4 m-2">
                    ...
                    >
                        ...
                        <Text className="font-bold text-right text-blue-500">
                            EDIT
                        </Text>
                    </View>
