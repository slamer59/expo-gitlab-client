...
import RgpdPolicy from './rgpd';

// Generated by: https://app.privacypolicies.com/download/e1ba2e5e-3243-45e1-9c23-ee6a458da68f
...
- __Application__ refers to Gitalchemy, the software program provided by the Company.



- __Company__ (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Gitalchemy.
...
- By email: [thomas.pedot@pedot.cc](mailto:thomas.pedot@pedot.cc)
`


const thirdPartyNoticeContent = `
# Notice of Third-Party Software

This application uses third-party software components. The following is a list of these components and their licenses:
...
The above listed software components may be subject to their own licenses. Please refer to the respective project websites or documentation for more information on their specific licenses.

## Acknowledgments

We would like to express our gratitude to the developers and contributors of these open-source projects. Their work has been instrumental in the creation of this application.

## Disclaimer

This list may not be exhaustive and is subject to change as the project evolves. For the most up-to-date information, please refer to the package.json file in the project repository.

If you believe any software is missing from this list or if you have any questions regarding the use of third-party software in this application, please contact us at [thomas.pedot@pedot.cc](mailto:thomas.pedot@pedot.cc).
    ...
    return (
        <SafeAreaView className="flex-1">
            ...
            >
                ...
                {/* <Markdown className="mb-4" style={styles}>
